...
宜家所有智能傢私有3种協議，wifi直駁，藍牙mesh，zigbee。wifi版最簡單，輸入wifi密碼就可以直接使用，壞處係功耗高，通常需要接駁220v電源，電芯肯定帶唔郁，需要聯網先可以使用。藍牙mesh同zigbee都需要網關先可以使用，好處係呢兩樣都可以使用電芯，因為功耗低。分別係藍牙價錢平，zigbee貴，但zigbee可以做到本地策略，即係冇網絡亦可以使用。網關係一個將藍牙信號變成wifi信號嘅嘢，你手機都係一部，單獨買都係百幾蚊。有些設備自帶網關功能，例如隨便放一部手機係屋企，或者綠米智能開關，小米紅外音響play，呢d都係自帶網關可以比其他智能傢私使用嘅設備。
